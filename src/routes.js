...
import BuyflowHealthDeclaration from "./views/buyflow/healthDeclaration";
import BuyflowApplicationSubmitted from "./views/buyflow/applicationSubmitted";
import CustomerLivelinessCheck from "./views/buyflow/livelinessCheck";
